            ...
            <div className="w-full h-full ">
                <div className="container grid mt-5 items-center h-full px-5 mx-auto md:grid-cols-2 md:text-left">
                    ...
                    <motion.div variants={fadeIn("left", 0.5)}
                        ...
                        exit="hidden"
                    >
                        <h1 className="mb-3 text-center sm:text-start md:text-4xl text-xl  leading-tight md:mb-10">Hi 👋🏼.My name is,  <br />
                            <span className="text-secondary">ADIB BENSMINA</span></h1>
                        <p className="max-w-xl  text-center sm:text-start  mb-10 leading-8 text-base md:max-w-[37rem] md:mx-0 md:mb-16 md:text-[20px] md:leading-10 ">
